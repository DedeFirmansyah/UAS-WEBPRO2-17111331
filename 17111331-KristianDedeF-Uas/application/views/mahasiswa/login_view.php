	...
	<div class="row">
		<div class="col-lg-5 m-auto">
			<div class="card mt-5 bg-light login" style="padding-top: 30px;">
				...
				<h2 class="card-title text-center mt-3">Login Mahasiswa</h2>
				<div class="card-body">
					<form method="post" action="<?php echo base_url('LoginMahasiswa/aksi_login') ?>">
	          		 ...
	          		 <div class="col-12 forgot text-center">
	         			<label>Belum punya akun ? <a href="<?php echo base_url('LoginMahasiswa/register')?>">Daftar Disini</a></label>
	        		</div>
	        		<div class="col-12 forgot text-center">
